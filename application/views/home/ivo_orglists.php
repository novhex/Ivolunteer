...
<table id="tbl_organizations"  cellspacing="0" width="100%">
        ...
        <?php foreach($organization_lists as $org_info):?>
        	<tr>
        		...
        		<td><a href="#" data-orgid="<?php echo $org_info['org_id']; ?>" data-userlogged="<?php echo $this->session->userdata('userId'); ?>" class="join_org btn btn-primary"><i class="fa fa-user-plus"></i> Join </a> &nbsp; <a data-orgid="<?php echo $org_info['org_id']; ?>" href="<?php echo base_url('index.php/home/vieworganizationinfo/')."/".$org_info['org_id'];?>" class="org_information btn btn-info"> View Info </a></td>
        	</tr>	
        <?php endforeach; ?>
        </tbody>
