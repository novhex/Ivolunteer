...
<div class="container" style="margin-top:50px;">
	<div class="row">
		...
		<div class="col-md-12 well" id="register">
        <h3 style="text-align:center;"> <?php echo ucfirst($type); ?> Registration Form </h3>
      
       <form action="<?php echo base_url('index.php/home/volunteermanagement_addvolunteer');?>" method="POST" accept-charset="utf-8">
       <input type="hidden" name="reg_type" value="<?php echo "volunteer"; ?>" />
  ...
  <input  type="text" placeholder="Birthdate" name="txtbirth"  id="txtbirth" class="form-control">
